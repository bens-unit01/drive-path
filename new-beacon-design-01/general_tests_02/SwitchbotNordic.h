...
// pinout for the big IR receivers (tssp4038)
...
// pinout for the small IR receivers (tssp77038)
 #define	IRM_head            14 //IRM receive head   R4
 #define	IRM_tail            13	//IRM receive tail   R3
 #define	IRM_left    		10	//IRM receive left   R2
 #define	IRM_right   		11	//IRM receive right  R6
