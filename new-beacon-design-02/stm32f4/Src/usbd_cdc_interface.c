...
int fputc(int ch, FILE *fp)
{
	...
	HAL_StatusTypeDef  st =  HAL_UART_Transmit(&huart4, &c, 1, 1000);
...
{  
// source : https://github.com/micropython/micropython/blob/master/stmhal/usbd_cdc_interface.c 
 	debug_rx(Buf, 3); 
	USBD_CDC_SetRxBuffer(&USBD_Device, UserRxBuffer + 3);
