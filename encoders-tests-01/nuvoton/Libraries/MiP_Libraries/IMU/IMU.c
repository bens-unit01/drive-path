...
void IMU_Update3(void){
 accel_x = SPI_Sensor_Read_Int(AccelX_low, AccelX_high);
 accel_y = SPI_Sensor_Read_Int(AccelY_low, AccelY_high);
 gyro_x = SPI_Sensor_Read_Int(GyroX_low, GyroX_high);
 gyro_y = SPI_Sensor_Read_Int(GyroY_low, GyroY_high);	
}
